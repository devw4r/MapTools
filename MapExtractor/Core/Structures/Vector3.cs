...
namespace AlphaCoreExtractor.Core.Structures
{
    ...
    public struct Vector3 : IEquatable<Vector3>, IComparable<Vector3>
    {
        ...
        public static Vector3 FromReader(BinaryReader br)
        {
            return StorageRoom.PopVector3(br.ReadSingle(), br.ReadSingle(), br.ReadSingle());
        }
        ...
        {
            Vector3 vector = StorageRoom.PopVector3();
            vector.X = a.X - b.X;
            vector.Y = a.Y - b.Y;
            vector.Z = a.Z - b.Z;
        ...
        public Vector3 Clamp(ref Vector3 min, ref Vector3 max)
        {
            ...
            return StorageRoom.PopVector3(x, y, z);
        }
        ...
        {
            return StorageRoom.PopVector3(Math.Min(a.X, b.X), Math.Min(a.Y, b.Y), Math.Min(a.Z, b.Z));
        }
        ...
        {
            return StorageRoom.PopVector3(Math.Max(a.X, b.X), Math.Max(a.Y, b.Y), Math.Max(a.Z, b.Z));
        }
        ...
        public bool Compare2(Vector3 other)
        {
        ...
        {
            return base.GetHashCode();// (int)(Length() * 1000);
        }
